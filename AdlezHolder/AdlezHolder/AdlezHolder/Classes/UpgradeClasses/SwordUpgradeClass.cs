...
namespace AdlezHolder
{
    class SwordUpgradeClass
    {
        ...
        public void Update(GameTime gameTime)
        {
            ...
            lastNode = multiNodeArray[NodeRowIndex, NodeColumnIndex];
            if (keys.IsKeyDown(Keys.S) && oldKeys.IsKeyUp(Keys.S))
                {
                    ...
                    if (multiNodeArray[NodeRowIndex, NodeColumnIndex] != null)
                    {
                        multiNodeArray[NodeRowIndex, NodeColumnIndex].Selected = false;
                    }
                    else
                    {
                        NodeRowIndex = 1;
            ...
            oldKeys = keys;
            lastNode = multiNodeArray[NodeRowIndex, NodeColumnIndex];
            selectedNode = multiNodeArray[NodeRowIndex, NodeColumnIndex];
        }
