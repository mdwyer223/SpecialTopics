...
namespace AdlezHolder
{
    public class BottomLeftCorner : MapDataHolder
    {
        ...
        public BottomLeftCorner(string id)
            : base()
        {
        ...
        public override void Update(Map map, GameTime gameTime)
        {
            ...
            for (int i = 0; i < tripWires.Count; i++)
            {
                ...
                {
                    leftHall = new LeftHallway("BottomLeftCorner");
                    changeHall = true;
                }

                if(i == 1 && tripWires[i].IfTripped && map.Player.Direction == Orientation.UP)
                {
                    topLeft = new TopLeftCorner("BottomLeftCorner");
                    changeCorner = true;
                }
            }
